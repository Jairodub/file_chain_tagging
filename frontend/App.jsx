		...
		>
			...
			>
				...
				<div
					style={{
						...
						bottom: 0,
						background:
							"radial-gradient(circle at 20% 50%, rgba(99, 102, 241, 0.15), transparent 70%), radial-gradient(circle at 80% 70%, rgba(139, 92, 246, 0.15), transparent 70%)",
					}}
				/>
				<div style={{ position: "relative", zIndex: 10 }}>
					...
					>
						Securely verify and upload files with{" "}
						<span style={{ color: "#A5B4FC" }}>blockchain technology</span>
					</p>
				</div>
			</div>
			...
			>
				<button
					...
					style={{
						...
						border:
							"1px solid " +
							(activeTab === "upload" ? "#4F46E5" : "rgba(99, 102, 241, 0.2)"),
						borderRadius: "6px",
						cursor: "pointer",
						fontWeight: "600",
						fontSize: "1rem",
				...
				<button
					...
					style={{
						...
						border:
							"1px solid " +
							(activeTab === "verify" ? "#4F46E5" : "rgba(99, 102, 241, 0.2)"),
						borderRadius: "6px",
						cursor: "pointer",
						fontWeight: "600",
						fontSize: "1rem",
			...
			<div
				style={{
					...
					border: "1px solid rgba(99, 102, 241, 0.2)",
					backgroundImage:
						"radial-gradient(circle at 90% 10%, rgba(99, 102, 241, 0.1), transparent 60%)",
				}}
			>
